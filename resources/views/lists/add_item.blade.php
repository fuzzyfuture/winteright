...
@section('content')
    ...
    <div class="mb-4">
        {{ html()->label('order *', 'order')->class('form-label') }} <small class="ms-2 text-muted">note: lists are
            currently sorted by descending order. more options will be available in the future!</small>
